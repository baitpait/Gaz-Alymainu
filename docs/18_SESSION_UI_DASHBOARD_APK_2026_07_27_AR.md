...
> آخر تحديث: 2026-08-01. للمستجدات بعد هذه الجلسة (دين السوق، حذف مبيعات، جداول، …) راجع `docs/19_SESSION_MOBILE_MARKET_DEBT_SALES_VOID_2026_08_01_AR.md`.
> المستودع: `baitpait/Gaz-Alymainu` — الفرع `main`.
...
| تنقل الموبايل (غير سائق) | زر قائمة في الهيدر → درج بنفس روابط الشريط الجانبي |
...
## 2ب) درج تنقل الموبايل/APK (مدير ومحاسب)

**المشكلة:** الشريط الجانبي `hidden md:flex` — على الموبايل/APK لا يرى غير السائق روابط الإدارة.

**الحل:**
- زر همبرغر في الهيدر (`md:hidden`) لغير السائق
- درج ثابت من اليمين (RTL) بنفس روابط الشريط عبر `@include` لـ `components/layouts/partials/sidebar-nav`
- إغلاق: خلفية معتمة / Escape / بعد التنقل / زر X
- السائق بدون زر ولا درج؛ الشريط السفلي POS يبقى كما هو
