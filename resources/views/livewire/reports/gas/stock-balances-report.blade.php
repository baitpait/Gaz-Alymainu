<div>
    <div class="flex flex-wrap items-start justify-between gap-4 mb-6">
        <div>
            <h1 class="text-2xl font-bold text-[#1E293B]">أرصدة المخزون</h1>
    ...
    <div class="card p-4 mb-4 flex flex-wrap gap-4 items-end">
        ...
        <div class="card px-4 py-2 text-sm mr-auto"><span class="text-gray-500">إجمالي الكمية:</span> <span class="font-mono font-bold text-[#1E293B] mr-2" dir="ltr">{{ rtrim(rtrim(number_format($grandQty, 2), '0'), '.') }}</span></div>
    </div>
    ...
    <div class="card overflow-hidden mb-4">
        <div class="px-5 py-3 border-b border-[#E2E8F0] bg-[#F9F9FB] flex items-center justify-between">
