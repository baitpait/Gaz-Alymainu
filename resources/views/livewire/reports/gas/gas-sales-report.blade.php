<div>
    <div class="flex flex-wrap items-start justify-between gap-4 mb-6">
        <div>
            <h1 class="text-2xl font-bold text-[#3D3D3D]">تقرير مبيعات الغاز</h1>
    ...
    <div class="flex flex-wrap gap-3 mb-4">
        ...
        <div class="card px-4 py-2 text-sm"><span class="text-gray-500">على الحساب:</span> <span class="font-mono font-bold text-[#C9A227] mr-2" dir="ltr">{{ number_format($totals['credit'], 2) }}</span></div>
        ...
        <div class="card px-4 py-2 text-sm"><span class="text-gray-500">الكمية:</span> <span class="font-mono font-bold text-[#3D3D3D] mr-2" dir="ltr">{{ rtrim(rtrim(number_format($totals['qty'], 2), '0'), '.') }}</span></div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            <span class="rounded px-2 py-0.5 bg-[#C9A227]/10 text-[#C9A227] text-xs">على الحساب</span>
                        @endif
                    </td>
