    ...
    <div style="display:flex;align-items:center;gap:12px;">
        ...
        <div>
            <h1 style="font-size:18px;font-weight:800;color:#1E293B;line-height:1.2;">
                {{ $recordId ? 'تعديل الإيراد' : 'إضافة إيراد جديد' }}
            </h1>
        </div>
    </div>
    <div style="display:flex;gap:8px;">
        <a href="{{ route('income-entries.index') }}" wire:navigate class="btn btn-secondary" style="font-size:13px;text-decoration:none;">إلغاء</a>
...
<div class="card" style="max-width:680px;margin:0 auto;padding:28px;">
    <div style="display:flex;flex-direction:column;gap:18px;">
        ...
        <div>
            ...
            <input wire:model="description" type="text" class="input" placeholder="وصف الإيراد...">
        ...
        <div>
            ...
            <input wire:model="income_date" type="date" class="input">
            @error('income_date')<p class="field-error">{{ $message }}</p>@enderror
        </div>
