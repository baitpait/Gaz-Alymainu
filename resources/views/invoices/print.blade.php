...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .client-card .section-lbl { font-size: 11px; color: #1B6CA8; font-weight: 700; margin-bottom: 6px; text-transform: uppercase; letter-spacing: .5px; }
  .client-card .client-name { font-size: 16px; font-weight: 800; color: #1E293B; margin-bottom: 4px; }
...
<div class="page">
  ...
  <div style="margin-bottom:20px; padding:12px 16px; background:#FAFAFA; border:1px solid #E2E8F0; border-radius:6px; font-size:12px; color:#555;">
    <span style="font-weight:700; color:#1B6CA8;">ملاحظات: </span>{{ $invoice->notes }}
  </div>
  @endif
