...
body { font-family: xbriyaz, sans-serif; color: #1E293B; font-size: 10pt; direction: rtl; }
...
.header-company { font-size: 10pt; font-weight: bold; color: #1E293B; direction: ltr; text-align: center; }
...
.main-table td.ltr, .main-table th.ltr { direction: ltr; text-align: left; }
.summary-box { border: 1pt solid #CCCCCC; background: #FAFAFA; padding: 8pt 10pt; margin-bottom: 12pt; }
.summary-row { font-size: 9.5pt; margin-bottom: 4pt; overflow: hidden; }
.summary-row span:first-child { float: right; color: #555; }
.summary-row span:last-child { float: left; direction: ltr; font-weight: bold; }
.positive { color: #16A34A; }
.negative { color: #DC2626; }
.empty { color: #999; text-align: center; margin-top: 30pt; }
</style>
